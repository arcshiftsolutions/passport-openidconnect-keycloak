...
Strategy.prototype.authenticate = function(req, options) {
  ...
  if (req.query && req.query.code) {
    ...
    console.log('KC HINT2: ' + this._kcIdpHint);
    var kcIdpHint = options.prompt || this._kcIdpHint;
    if(kcIdpHint){
      params.kc_idp_hint = kcIdpHint;
    }
    console.log('KC HINT3: ' + JSON.stringify(params));
